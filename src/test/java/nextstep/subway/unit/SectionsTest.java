...
class SectionsTest {
    ...
    void addSectionWithNoConnectedStations() {
        ...
        // when & then
        assertThatThrownBy(() -> 신분당선구간.addSections(연결되지않은구간))
    ...
    void addSectionWithBothConnectedStations() {
        ...
        // when & then
        assertThatThrownBy(() -> 신분당선구간.addSections(또다른구간))
                .isInstanceOf(InvalidSectionException.class)
    ...
    void addSectionWithZeroDistance() {
        ...
        // when & then
        assertThatThrownBy(() -> {
            sections.addSections(zeroDistanceSection);
        })
                .isInstanceOf(InvalidSectionException.class)
    ...
    void addSectionWithInvalidDistance() {
        ...
        // when & then
        assertThatThrownBy(() -> {
            신분당선구간.addSections(invalidSection);
        })
                .isInstanceOf(InvalidSectionException.class)
